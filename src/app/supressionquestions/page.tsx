...
export default function page() {
  return (
    <Maxwrapper newClass=" flex bg-safeWhite max-w-screen-2xl py-[100px]">
      <div className=" border-2 m-auto   border-safeAccent p-5 ">
        <div className="bg-safeAccent p-4 mb-4">
          <h2 className=" h4 text-safeWhite capitalize text-center">
            {" "}
        ...
        <ScrollArea className=" bg-safePri  relative  m-auto overflow-auto py-3   h-80 px-3 ">
          ...
          <div className="flex flex-col   space-y-10">
            ...
            >
              ...
              <h2 className="group-hover:text-safeAccent m-0 flex-1 leading-5 h4 font-medium  text-zinc-900 ">
